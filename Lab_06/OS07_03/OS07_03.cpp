...
int main()
{
	...
	processes[0] = createProcess(L"C:\\Учёба БГТУ\\3 курс\\5 семестр\\Лабораторные\\Операционные системы\\Lab_06\\Debug\\OS06_03A.exe").hProcess;
	processes[1] = createProcess(L"C:\\Учёба БГТУ\\3 курс\\5 семестр\\Лабораторные\\Операционные системы\\Lab_06\\Debug\\OS06_03B.exe").hProcess;
