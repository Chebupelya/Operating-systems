...
int main(int argc, char* argv[])
{
	try 
	{
		if (argc == 4) 
		{
			...
			icpu = SetThreadIdealProcessor(ht, 1);
			cout << "Processor = " << icpu << endl;
			...
			LPCWSTR path1 = L"C:\\Учёба БГТУ\\3 курс\\5 семестр\\Лабораторные\\Операционные системы\\Lab_05\\x64\\Debug\\OS05_02x.exe";
			LPCWSTR path2 = L"C:\\Учёба БГТУ\\3 курс\\5 семестр\\Лабораторные\\Операционные системы\\Lab_05\\x64\\Debug\\OS05_02x.exe";
