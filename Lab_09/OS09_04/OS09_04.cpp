...
#include <cstdlib>
#include "Windows.h"
#define FILE_PATH L"C:/Учёба БГТУ/3 курс/5 семестр/Лабораторные/Операционные системы/Lab_09/OS09_01.txt"
#define DIR_PATH L"C:/Учёба БГТУ/3 курс/5 семестр/Лабораторные/Операционные системы/Lab_09"
int rowC = 0;
...
int main()
{
    ...
    printWatchRowFileTxt(fileName, 40000);
}
